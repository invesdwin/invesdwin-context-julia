...
public class InputsAndResultsTestInteger {
    ...
    public InputsAndResultsTestInteger(final IScriptTaskRunnerJulia runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        ...
        new AScriptTaskJulia<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestInteger.class.getSimpleName() + ".jl",
