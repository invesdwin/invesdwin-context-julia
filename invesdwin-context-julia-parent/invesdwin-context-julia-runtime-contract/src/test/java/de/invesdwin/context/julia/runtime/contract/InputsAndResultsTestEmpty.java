...
public class InputsAndResultsTestEmpty {
    ...
    public InputsAndResultsTestEmpty(final IScriptTaskRunnerJulia runner) {
        this.runner = runner;
    }
    ...
    public void testEmpty() {
        ...
        new AScriptTaskJulia<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmpty.class.getSimpleName() + ".jl",
