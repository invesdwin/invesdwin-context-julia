...
public class InputsAndResultsTestNullPutGet {
    ...
    public InputsAndResultsTestNullPutGet(final IScriptTaskRunnerJulia runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskJulia<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestNullPutGet.class.getSimpleName() + ".jl",
