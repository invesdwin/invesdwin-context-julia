...
public class InputsAndResultsTestEmptyMatrixValue {
    ...
    public InputsAndResultsTestEmptyMatrixValue(final IScriptTaskRunnerJulia runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        ...
        new AScriptTaskJulia<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmptyMatrixValue.class.getSimpleName() + ".jl",
