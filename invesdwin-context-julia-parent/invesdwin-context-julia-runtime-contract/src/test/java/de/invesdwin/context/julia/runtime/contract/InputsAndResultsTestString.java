...
public class InputsAndResultsTestString {
    ...
    public InputsAndResultsTestString(final IScriptTaskRunnerJulia runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        ...
        new AScriptTaskJulia<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestString.class.getSimpleName() + ".jl",
