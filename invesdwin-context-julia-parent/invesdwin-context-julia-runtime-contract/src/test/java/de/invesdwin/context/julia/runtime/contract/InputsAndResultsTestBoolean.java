...
public class InputsAndResultsTestBoolean {
    ...
    public InputsAndResultsTestBoolean(final IScriptTaskRunnerJulia runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        ...
        new AScriptTaskJulia<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestBoolean.class.getSimpleName() + ".jl",
