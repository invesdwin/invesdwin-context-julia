...
public class InputsAndResultsTestShort {
    ...
    public InputsAndResultsTestShort(final IScriptTaskRunnerJulia runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        ...
        new AScriptTaskJulia<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestShort.class.getSimpleName() + ".jl",
