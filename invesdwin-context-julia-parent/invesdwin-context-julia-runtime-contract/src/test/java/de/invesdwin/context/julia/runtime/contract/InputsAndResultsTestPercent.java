...
public class InputsAndResultsTestPercent {
    ...
    public InputsAndResultsTestPercent(final IScriptTaskRunnerJulia runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        ...
        new AScriptTaskJulia<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestPercent.class.getSimpleName() + ".jl",
