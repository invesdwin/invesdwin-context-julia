...
@NotThreadSafe
public class Ju4jaScriptTaskResultsJulia implements IScriptTaskResultsJulia {

    private final Ju4jaScriptTaskEngineJulia engine;

    public Ju4jaScriptTaskResultsJulia(final Ju4jaScriptTaskEngineJulia engine) {
        this.engine = engine;
    }

    @Override
    public Ju4jaScriptTaskEngineJulia getEngine() {
        return engine;
    }
