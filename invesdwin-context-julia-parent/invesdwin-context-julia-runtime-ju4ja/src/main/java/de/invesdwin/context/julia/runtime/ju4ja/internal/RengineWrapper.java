...
import de.invesdwin.context.julia.runtime.ju4ja.Ju4jaProperties;
...
public final class RengineWrapper {
    ...
    private RengineWrapper() {
        DynamicInstrumentationReflections.addPathToJavaLibraryPath(Ju4jaProperties.JRI_LIBRARY_PATH);
